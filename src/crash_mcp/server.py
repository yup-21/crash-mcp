...
def register_all_tools(mcp: FastMCP):
    ...
    - Script Utilities (3个): list_scripts, read_script, save_script
    """
    from crash_mcp.tools import session_mgmt
    session_mgmt.register(mcp)
    
    # Script tools removed - usage moved to skill resources
    # from crash_mcp.tools import script_tools
    # script_tools.register(mcp)

    # Prompts and resources hidden - provided via skill
